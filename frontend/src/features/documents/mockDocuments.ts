...
export const MOCK_DOCUMENTS: MockDocument[] = [
  ...
  {
    id: 'doc-5',
    name: 'Q2 2025 Sustainability Report.pdf',
    type: 'PDF',
    size: '7.8 MB',
    owner: 'Reem Al-Harbi',
    uploadedAt: '3 Jul 2026, 14:02',
    updatedAt: '3 Jul 2026, 14:20',
    status: 'PROCESSED',
    engagement: 'FY 2026 sustainability disclosure',
  },
  {
    id: 'doc-6',
    name: 'Facility Energy Log — August.csv',
    type: 'PDF',
    size: '0.6 MB',
    owner: 'Faisal Al-Dossary',
    uploadedAt: '8 Jul 2026, 10:24',
    updatedAt: '8 Jul 2026, 10:24',
    status: 'PENDING',
    engagement: 'Operational emissions assurance',
  },
  {
    id: 'doc-7',
    name: 'Supplier Scorecard 2025.xlsx',
    type: 'PDF',
    size: '2.4 MB',
    owner: 'Adel Al-Qahtani',
    uploadedAt: '14 Jul 2026, 07:48',
    updatedAt: '14 Jul 2026, 07:48',
    status: 'PROCESSING',
    engagement: 'Supplier due diligence',
  },
  {
    id: 'doc-8',
    name: 'Biodiversity Impact Study.pdf',
    type: 'PDF',
    size: '4.2 MB',
    owner: 'Noura Al-Zahrani',
    uploadedAt: '6 Jul 2026, 16:35',
    updatedAt: '6 Jul 2026, 16:40',
    status: 'PROCESSED',
    engagement: 'Water stewardship review',
  },
  {
    id: 'doc-9',
    name: 'Carbon Footprint Review.pdf',
    type: 'PDF',
    size: '3.6 MB',
    owner: 'Reem Al-Harbi',
    uploadedAt: '2 Jul 2026, 12:10',
    updatedAt: '2 Jul 2026, 12:30',
    status: 'FAILED',
    engagement: 'FY 2026 sustainability disclosure',
  },
];
